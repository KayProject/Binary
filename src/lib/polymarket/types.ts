...
export function gammaMarketToMarket(gammaMarket: GammaMarket): Market {
  ...
  return {
    ...
    oneDayPriceChange: gammaMarket.oneDayPriceChange,
    feesEnabled: gammaMarket.feesEnabled ?? false,
    feeRateBps: feeSchedule?.rate ?? 0,
    feeExponent: feeSchedule?.exponent ?? 0,
